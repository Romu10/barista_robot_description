...
class CamBotOdomToTf(Node):
    ...
    def __init__(self, robot_base_frame="robot1/base_link"):
        super().__init__('b1_odom_to_tf_broadcaster_node')
        ...
        self.get_logger().warning("b1_odom_to_tf_broadcaster_node READY!")
