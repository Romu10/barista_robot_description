...
class CamBotOdomToTf(Node):
    ...
    def __init__(self, robot_base_frame="robot2/base_link"):
        super().__init__('b2_odom_to_tf_broadcaster_node')
        ...
        self.get_logger().warning("b2_odom_to_tf_broadcaster_node READY!")
